...
Recommendations:
For a better experience installing and running your projects in Anypoint Studio for the first time, we also recommend that you install the following pre-requisites:
- JDK 17 & Java 17
- Maven 3.9
